...
public class ItemEffectDataBase : MonoBehaviour
{
    ...
    public void UseItem(Item _item)
    {
        ...
        {
            StartCoroutine(theWeaponManager.ChangeWeaponCoroutione(_item.weaponType, _item.itemName));
        }
                    ...
                    for(int y = 0; y < itemEffects[x].part.Length; y++)
                    {
                        switch (itemEffects[x].part[y])
                        {
                            ...
                            case DP:
                                ...
                                break;
                            case THIRSTY:
                                thePlayerStatus.IncreaseThiesty(itemEffects[x].num[y]);
                                break;
                            case HUNGRY:
